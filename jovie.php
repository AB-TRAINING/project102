...
<head>
  ...
  <link href="assets/css/jovie-opl.webflow.css?ver=1.1" rel="stylesheet" type="text/css">
  ...
  <link href="image/webclip.jpg" rel="apple-touch-icon">
  <style type="text/css">
body {
  ...
  <div class="columns w-row">
    ...
    <div class="rightcontent w-col w-col-6 w-col-stack">
      <div data-w-id="3fd5aeb3-22da-ed60-7286-0d11f16597d3" style="opacity:0" class="content">
        ...
        <p class="bio">Thank you for visiting my sample Webpage. </p>
        ...
        <div class="credit"><a href="/index.php" class="credit-links"><b>Go Back to Home Page</b></a>
        </div>
      </div>
    </div>
  </div>
