            ...
            <div class="album py-5 bg-light">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="/sabo.php" type="button" class="btn btn-sm btn-outline-secondary">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                <img class="card-img-top" src="/assets/image/romeo-tmb.png" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Romeo Ramosa</h5>
                                    <p class="card-text">Qucik Setup for Romeo Ramosa</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="/pm.php" type="button" class="btn btn-sm btn-outline-secondary">View</a>
                                        </div>
